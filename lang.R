...
lang <- list(
  ...
  dispersion_histogram_stock_toggle = 'Incluir OH',
  dispersion_histogram_stock_toggle_title = 'Mostrar el inventario total (OH de las tiendas + mercancía de la promoción).',
