...
ddv_oh_1 <- rlang::sym(paste('is_oh', wmwk1, sep = '_'))
ddv_oh_2 <- rlang::sym(paste('is_oh', wmwk2, sep = '_'))
wkly_qty1 <- rlang::sym(paste('is_oh', wmwk1, sep = '_'))
wkly_qty2 <- rlang::sym(paste('is_oh', wmwk2, sep = '_'))
pretty_names <- c(categoria = 'category_nbr', articulo = 'item_nbr', descripcion = 'item1_desc.x')
...
# htmltools::tagList(print(summary_table, type = 'html', scalebox = 0.7))
# htmltools::doRenderTags()
print(summary_table, type = 'html', scalebox = 0.2)
```
