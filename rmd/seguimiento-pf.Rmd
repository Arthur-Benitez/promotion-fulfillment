...
## IS/Ventas - Gráficas Individuales

Indicadores durante la estrategia, calculados al cierre de las semanas Walmart.

```{r metrics_ind, echo=FALSE, fig.height=5, fig.width=19, message=FALSE, warning=FALSE}
graph_metrics %>%
  walk(plot)
```

## IS/Ventas - Gráficas de Resumen
...
## Dispersión - Gráficas Individuales

Dispersión durante la estrategia.

```{r box_ind, echo=FALSE, fig.height=5, fig.width=19, message=FALSE, warning=FALSE}
graph_box %>%
  walk(plot)
```

## Dispersión - Gráficas de Resumen
